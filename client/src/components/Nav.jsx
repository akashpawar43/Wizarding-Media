    ...
    return (
        <header className="bg-white p-4">
            <nav className="container mx-auto flex justify-between items-center">
                ...
                <ul className={`${isOpen ? 'block' : 'hidden'} lg:flex space-y-2 lg:space-y-0 lg:space-x-4 z-10 bg-white text-center absolute lg:static lg:bg-transparent w-full lg:w-auto top-24 left-0 lg:top-0 lg:left-auto`}>
